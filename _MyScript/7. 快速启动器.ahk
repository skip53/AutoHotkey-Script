...
appStarter("#s", "D:\TechnicalSupport\Sandbox\LL\1LongAndTrust\drive\D\TechnicalSupport\Users\LL\AppData\Roaming\Spotify\Spotify.exe", "Spotify")
...
appStarter("#g", "录制gif")
appStarter("#s", "d:\Dropbox\Technical_Backup\ProgramFiles.Untrust\ColorPic 4.1  屏幕取色小插件 颜色 色彩 配色\#ColorPic.exe", "颜色配色")
